...
PairStyle(qsp/hms,PairQspHMSym)

#else

#ifndef LMP_PAIR_QSP_HM_H
#define LMP_PAIR_QSP_HM_H

#include "pair.h"

namespace LAMMPS_NS {

class PairQspHMSym : public Pair {
 public:
  PairQspHMSym(class LAMMPS *);
  virtual ~PairQspHMSym();
