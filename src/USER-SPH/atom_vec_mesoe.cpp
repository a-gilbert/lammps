...
//Modified lammps code by Austin Gilbert
//SPH electrons!!

#include <cstring>
#include <cstdlib>
#include "atom_vec_mesoe.h"
#include "atom.h"
#include "comm.h"
#include "domain.h"
#include "modify.h"
...
AtomVecMesoe::AtomVecMesoe(LAMMPS *lmp) : AtomVec(lmp)
{
  molecular = 0;
  mass_type = 1;
  forceclearflag = 1;
...
void AtomVecMesoe::copy(int i, int j, int delflag) {
...
void AtomVecMesoe::force_clear(int n, size_t nbytes)
{
...
int AtomVecMesoe::pack_comm_hybrid(int n, int *list, double *buf) {
...
int AtomVecMesoe::unpack_comm_hybrid(int n, int first, double *buf) {
...
int AtomVecMesoe::pack_border_hybrid(int n, int *list, double *buf) {
...
int AtomVecMesoe::unpack_border_hybrid(int n, int first, double *buf) {
...
int AtomVecMesoe::pack_reverse_hybrid(int n, int first, double *buf) {
...
int AtomVecMesoe::unpack_reverse_hybrid(int n, int *list, double *buf) {
...
int AtomVecMesoe::pack_comm(int n, int *list, double *buf, int pbc_flag,
                           int *pbc) {
...
int AtomVecMesoe::pack_comm_vel(int n, int *list, double *buf, int pbc_flag,
                               int *pbc) {
...
void AtomVecMesoe::unpack_comm(int n, int first, double *buf) {
...
void AtomVecMesoe::unpack_comm_vel(int n, int first, double *buf) {
...
int AtomVecMesoe::pack_reverse(int n, int first, double *buf) {
...
void AtomVecMesoe::unpack_reverse(int n, int *list, double *buf) {
...
int AtomVecMesoe::pack_border(int n, int *list, double *buf, int pbc_flag,
                             int *pbc) {
...
int AtomVecMesoe::pack_border_vel(int n, int *list, double *buf, int pbc_flag,
                                 int *pbc)
{
  int i,j,m;
...
void AtomVecMesoe::unpack_border(int n, int first, double *buf) {
...
void AtomVecMesoe::unpack_border_vel(int n, int first, double *buf) {
...
int AtomVecMesoe::pack_exchange(int i, double *buf) {
...
int AtomVecMesoe::unpack_exchange(double *buf) {
...
int AtomVecMesoe::pack_restart(int i, double *buf) {
  int m = 1;
  buf[m++] = x[i][0];
  buf[m++] = x[i][1];
  buf[m++] = x[i][2];
...
int AtomVecMesoe::unpack_restart(double *buf) {
  int nlocal = atom->nlocal;
  if (nlocal == nmax) {
    grow(0);
...
void AtomVecMesoe::create_atom(int itype, double *coord) {
  int nlocal = atom->nlocal;
  if (nlocal == nmax)
    grow(0);
...
void AtomVecMesoe::data_atom(double *coord, imageint imagetmp, char **values) {
  int nlocal = atom->nlocal;
...
void AtomVecMesoe::pack_data(double **buf)
{
  int nlocal = atom->nlocal;
...
void AtomVecMesoe::write_data(FILE *fp, int n, double **buf)
{
  for (int i = 0; i < n; i++)
...
void AtomVecMesoe::pack_property_atom(int index, double *buf,
...
bigint AtomVecMesoe::memory_usage() {
  bigint bytes = 0;
